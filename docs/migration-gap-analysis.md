...
| B10 | High | 🟡 **FOLLOW-UP (#135/#141).** Session end/pause/end-summary, daily & session reports, navigation history, and verdict correction remain unimplemented. D14 accepts this as visible post-cutover UX parity work, not a correctness/privacy deletion gate. | `docs/migration-gap-analysis.md` P3-3 |
...
| P3-8 | Session pause + end summary | FOLLOW-UP (#141) | S | A `paused` flag short-circuiting observe/heartbeat; summary folds into P3-3. |
